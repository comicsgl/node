var _ = require("underscore"),
	...
	Strategy = require("passport-comicsgl").Strategy;
...
var API = function( options ){
	...
	passport.use(new Strategy({
		...
		callbackURL: "/auth/comicsgl/callback", // option?
...
API.prototype = {
	...
	auth: function(){
		if( arguments[1] ) {
			return passport.authenticate('comicsgl', arguments[0], arguments[1]);
		} else {
			return passport.authenticate('comicsgl', arguments[0]);
		}
	},
